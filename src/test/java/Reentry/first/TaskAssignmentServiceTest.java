...
class TaskAssignmentServiceTest {
    ...
    @Test
    void assignTaskToEmployee_shouldThrowBusinessValidationException_whenTaskAssignmentAlreadyExists() {
        ...
        when(taskAssignmentRepository.existsByNameAndAndDeadline(
                dto.getName(),
                dto.getDeadline()
        )).thenReturn(true);
